...
export interface CodeActionProvider {
     ...
     */
    getCodeActions(document: LangiumDocument, params: CodeActionParams, cancelToken?: Cancellation.CancellationToken): MaybePromise<Array<Command | CodeAction> | undefined>;
}
