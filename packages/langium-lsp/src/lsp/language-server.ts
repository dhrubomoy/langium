...
import { eagerLoad, URI, DocumentState, isOperationCancelled } from 'langium-core';
import type { LangiumCoreServices, ConfigurationInitializedParams, LangiumDocument } from 'langium-core';
