...
import { stream, URI, Emitter } from 'langium-core';
import type { DocumentBuilder, TextDocument, WorkspaceLock, WorkspaceManager, ServiceRegistry, MaybePromise } from 'langium-core';
