...
import type { Grammar, Reference, AstNode, CstNode, LeafCstNode, GenericAstNode, Mutable, RootCstNode, ParseResult, LexReport, Linker, DehydrateContext, HydrateContext, Hydrator } from 'langium-core';
import { GrammarAST, isRootCstNode, isCompositeCstNode, isLeafCstNode, isAstNode, isReference, AstUtils, BiMap, CstUtils } from 'langium-core';
import type { Lexer } from '../parser/lexer.js';
import type { LangiumChevrotainServices } from '../parser/chevrotain-services.js';

export type { Hydrator, DehydrateContext, HydrateContext } from 'langium-core';

// GrammarAST type alias
type AbstractElement = GrammarAST.AbstractElement;

// Runtime values
const { isAbstractElement } = GrammarAST;
const { streamAst } = AstUtils;
const { streamCst } = CstUtils;
...
export class DefaultHydrator implements Hydrator {
    ...
    protected dehydrateLexerReport(lexerReport: LexReport): LexReport {
