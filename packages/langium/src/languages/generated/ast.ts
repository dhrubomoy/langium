...
/* eslint-disable */
import * as langium from 'langium-core';
...
export interface SkipBlock extends langium.AstNode {
    readonly $container: Grammar;
    readonly $type: 'SkipBlock';
...
export function isSkipBlock(item: unknown): item is SkipBlock {
    return reflection.isInstance(item, SkipBlock.$type);
}
...
export interface TokensBlock extends langium.AstNode {
    readonly $container: Grammar;
    readonly $type: 'TokensBlock';
    terminals: Array<TerminalRule>;
}

export const TokensBlock = {
    $type: 'TokensBlock',
    terminals: 'terminals'
} as const;

export function isTokensBlock(item: unknown): item is TokensBlock {
    return reflection.isInstance(item, TokensBlock.$type);
}
...
export class LangiumGrammarAstReflection extends langium.AbstractAstReflection {
    override readonly types = {
        ...
        TokensBlock: {
            name: TokensBlock.$type,
            properties: {
                terminals: {
                    name: TokensBlock.terminals,
                    defaultValue: []
                }
            },
            superTypes: []
