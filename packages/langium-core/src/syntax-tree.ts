...
/**
 * Minimal token type descriptor for CST leaf nodes.
 * Chevrotain's `TokenType` is a structural supertype of this interface.
 */
export interface CstTokenType {
    name: string;
    PATTERN?: unknown;
}
...
export interface AstNode {
     ...
     * This is the backend-agnostic replacement for `$cstNode`.
     */
    readonly $syntaxNode?: SyntaxNode;
    /**
     * The Concrete Syntax Tree (CST) node of the text range from which this node was parsed.
     * @deprecated Use `$syntaxNode` instead. This property is retained for backward compatibility.
     */
...
export interface LeafCstNode extends CstNode {
    readonly tokenType: CstTokenType;
}
