 ...
 * This provides only parser-agnostic core services. Parser-specific services
 * (e.g., Chevrotain parser, lexer) must be provided by a separate module
...
/**
 * Context required for creating the default shared core dependency injection module.
 */
