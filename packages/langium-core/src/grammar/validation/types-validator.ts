...
/**
 * Minimal service interface for type validation checks registration.
 */
export interface LangiumGrammarTypesValidatorServices extends LangiumCoreServices {
    readonly validation: LangiumCoreServices['validation'] & {
        readonly LangiumGrammarTypesValidator: LangiumGrammarTypesValidator;
    }
}

export function registerTypeValidationChecks(services: LangiumGrammarTypesValidatorServices): void {
