...
/**
 * Minimal service interface for Langium grammar validation.
 * In the full Langium package, this is LangiumGrammarServices which extends LangiumCoreServices
 * with grammar-specific validation services.
 */
export interface LangiumGrammarValidatorServices extends LangiumCoreServices {
    readonly validation: LangiumCoreServices['validation'] & {
        readonly LangiumGrammarValidator: LangiumGrammarValidator;
    }
}
...
export function registerValidationChecks(services: LangiumGrammarValidatorServices): void {
